...
class MockDocumentReference<T extends Object?> implements DocumentReference<T>, Equatable {
  final String _id;
  ...
  @override
  bool operator ==(Object o) => o is DocumentReference && o.firestore == _firestore && o.path == _path;
